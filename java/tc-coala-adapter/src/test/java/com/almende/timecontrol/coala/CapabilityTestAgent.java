/* $Id: 333340ca237526823ff66a2eaea11b974ef8e657 $
...
/**
 * {@link CapabilityTestAgent}
 * 
 * @version $Revision: 312 $
 * @author <a href="mailto:Rick@almende.org">Rick</a>
 *
 */
public class CapabilityTestAgent extends BasicAgent implements
		ModelComponent<AgentID>
{
	...
	/**
	 * {@link CapabilityTestAgent} constructor
	 * 
	 * @param binder
	 */
	@Inject
	protected CapabilityTestAgent(final Binder binder)
	{
		super(binder);
	}
	...
	protected TimeControlCapabilityImpl getSimulator()
	{
		return (TimeControlCapabilityImpl) getBinder().inject(
